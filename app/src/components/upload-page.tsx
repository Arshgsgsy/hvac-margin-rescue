            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4 max-w-3xl mx-auto pt-8">
                ...
                <div className="text-center p-4">
                  ...
                  <p className="text-muted-foreground text-xs mt-1">LLM-powered analysis</p>
                </div>
                <div className="text-center p-4">
                  <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-3">
                ...
                <div className="rounded-xl border border-border bg-card p-5">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Generated by the analysis agent from portfolio data</p>
                    </div>
                  </div>
