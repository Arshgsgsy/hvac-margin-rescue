...
import { PipelineResult, UploadResult } from '@/lib/types'
...
const STEPS: StepDef[] = [
  ...
  },
  {
    id: '2b_merge',
    label: 'Merge & Enrich',
    script: 'pipeline/2_load + pipeline/3_flag',
    description: 'Combine billing, change orders, and RFI data into project-level analysis tables',
    duration: 0,
    logs: [],
  },
  {
    ...
    script: 'portfolio_scan.py + project_flagging.py + risk_scorer.py + root_cause_summary.py',
  ...
  },
  {
    ...
    script: 'pipeline/4_llm/04_export_to_llm.py',
    description: 'Build structured project packets for downstream agent analysis',
    duration: 0,
    logs: [],
  },
]
