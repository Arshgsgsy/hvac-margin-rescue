...
MATERIAL_SUMMARY_FILE = BASE_DIR / "output_summaries" / "material_project_sov_summary.csv"
BUDGET_FILE = BASE_DIR / "hvac_data" / "sov_budget_all.csv"
OUTPUT_FILE = BASE_DIR / "output_summaries" / "material_vs_budget.csv"

con = duckdb.connect()

# Load summarized actual material costs
con.execute(f"""
