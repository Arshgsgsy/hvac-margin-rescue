...
BILLING_FILE = BASE_DIR / "output_summaries" / "project_billing_analysis.csv"
CHANGE_FILE = BASE_DIR / "output_summaries" / "change_summary.csv"
OUTPUT_FILE = BASE_DIR / "output_summaries" / "project_full_analysis.csv"

con = duckdb.connect()

# Load the two summary tables
con.execute(f"""
...
# Merge them and create final project-level file
con.execute(f"""
COPY (
    SELECT
        b.*,
